!function(){"use strict";function i(){return{indexOf:function(i,n,t){void 0===t&&(t=0),t<0&&(t+=i.length),t<0&&(t=0);for(var e=i.length;t<e;t++)if(t in i&&i[t]===n)return t;return-1},prependMethod:function(i,n,t){var e=i[n];i[n]=function(){var i=Array.prototype.slice.call(arguments);return t.apply(this,i),e?e.apply(this,i):void 0}},deepExtend:function i(n,t){if(angular.isArray(t)){n=angular.isArray(n)?n:[];for(var e=0;e<t.length;e++)n[e]=i(n[e]||{},t[e])}else if(angular.isObject(t))for(var r in t)n[r]=i(n[r]||{},t[r]);else n=t;return n}}}function n(i){var n=0,t=function(i){var t=!1;return angular.forEach(i,function(i){angular.isDefined(i.id)||(i.id="series-"+n++,t=!0)}),t},e=["xAxis","yAxis"],r=function(n,t,r){var a={},c={chart:{events:{}},title:{},subtitle:{},series:[],credits:{},plotOptions:{},navigator:{enabled:!1}};return a=r.options?i.deepExtend(c,r.options):c,a.chart.renderTo=t[0],angular.forEach(e,function(t){angular.isDefined(r[t])&&(a[t]=angular.copy(r[t]),(angular.isDefined(r[t].currentMin)||angular.isDefined(r[t].currentMax))&&(i.prependMethod(a.chart.events,"selection",function(i){var e=this;i[t]?n.$apply(function(){n.config[t].currentMin=i[t][0].min,n.config[t].currentMax=i[t][0].max}):n.$apply(function(){n.config[t].currentMin=e[t][0].dataMin,n.config[t].currentMax=e[t][0].dataMax})}),i.prependMethod(a.chart.events,"addSeries",function(i){n.config[t].currentMin=this[t][0].min||n.config[t].currentMin,n.config[t].currentMax=this[t][0].max||n.config[t].currentMax})))}),r.title&&(a.title=r.title),r.subtitle&&(a.subtitle=r.subtitle),r.credits&&(a.credits=r.credits),r.size&&(r.size.width&&(a.chart.width=r.size.width),r.size.height&&(a.chart.height=r.size.height)),a},a=function(i,n){var t=i.getExtremes();n.currentMin===t.dataMin&&n.currentMax===t.dataMax||i.setExtremes(n.currentMin,n.currentMax,!1)},c=function(i,n,t){(n.currentMin||n.currentMax)&&i[t][0].setExtremes(n.currentMin,n.currentMax,!0)},o=function(i){return angular.extend({},i,{data:null,visible:null})};return{restrict:"EAC",replace:!0,template:"<div></div>",scope:{config:"=",disableDataWatch:"="},link:function(n,s,u){var f={},d=function(e){var r,a=[];if(e){var c=t(e);if(c)return!1;if(angular.forEach(e,function(i){a.push(i.id);var n=h.get(i.id);n?angular.equals(f[i.id],o(i))?(void 0!==i.visible&&n.visible!==i.visible&&n.setVisible(i.visible,!1),n.setData(angular.copy(i.data),!1)):n.update(angular.copy(i),!1):h.addSeries(angular.copy(i),!1),f[i.id]=o(i)}),n.config.noData){var s=!1;for(r=0;r<e.length;r++)if(e[r].data&&e[r].data.length>0){s=!0;break}s?h.hideLoading():h.showLoading(n.config.noData)}}for(r=h.series.length-1;r>=0;r--){var u=h.series[r];"highcharts-navigator-series"!==u.options.id&&i.indexOf(a,u.options.id)<0&&u.remove(!1)}return!0},h=!1,g=function(){h&&h.destroy(),f={};var i=n.config||{},t=r(n,s,i),a=i.func||void 0;h=i.useHighStocks?new Highcharts.StockChart(t,a):new Highcharts.Chart(t,a);for(var o=0;o<e.length;o++)i[e[o]]&&c(h,i[e[o]],e[o]);i.loading&&h.showLoading()};g(),n.disableDataWatch?n.$watchCollection("config.series",function(i,n){d(i),h.redraw()}):n.$watch("config.series",function(i,n){var t=d(i);t&&h.redraw()},!0),n.$watch("config.title",function(i){h.setTitle(i,!0)},!0),n.$watch("config.subtitle",function(i){h.setTitle(!0,i)},!0),n.$watch("config.loading",function(i){i?h.showLoading():h.hideLoading()}),n.$watch("config.credits.enabled",function(i){i?h.credits.show():h.credits&&h.credits.hide()}),n.$watch("config.useHighStocks",function(i,n){i!==n&&g()}),angular.forEach(e,function(i){n.$watch("config."+i,function(n,t){n!==t&&n&&(h[i][0].update(n,!1),a(h[i][0],angular.copy(n)),h.redraw())},!0)}),n.$watch("config.options",function(i,n,t){i!==n&&(g(),d(t.config.series),h.redraw())},!0),n.$watch("config.size",function(i,n){i!==n&&i&&h.setSize(i.width||void 0,i.height||void 0)},!0),n.$on("highchartsng.reflow",function(){h.reflow()}),n.$on("$destroy",function(){h&&(h.destroy(),setTimeout(function(){s.remove()},0))})}}}angular.module("highcharts-ng",[]).factory("highchartsNGUtils",i).directive("highchart",["highchartsNGUtils",n])}();
