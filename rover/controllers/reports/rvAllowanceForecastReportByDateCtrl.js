...
sntRover.controller('RVAllowanceForecastReportByDateCtrl', ['$scope', 'RVReportMsgsConst', '$timeout', '$interval', '$stateParams', 'RVreportsSrv', function ($scope, reportMsgs, $timeout, $interval, $stateParams, reportsSrv) {
